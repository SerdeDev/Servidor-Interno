...
router.post("/getDeudaCnaePublicos", async (req, res) => {
  try {
    ...
    // 3. Consultas CNAE con filtro de públicos (cedula contiene "G")
    ...
    console.error("Error en /getDeudaCnaePublicos:", error);
